  ...
  return (
    <>
      <section
        ...
        <div className="flex w-11/12 flex-col items-center lg:w-10/12 lg:flex-row lg:items-start lg:justify-evenly">
          ...
          <img src="/assets/welcome_robot.png" className="hidden aspect-square w-1/3 lg:block" />
        </div>
